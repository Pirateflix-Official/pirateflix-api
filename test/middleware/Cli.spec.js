...
describe('Cli', () => {
  ...
  function testGetTorrent(type: string): void {
    ...
    it('should get a torrent from a link', done => {
      const link = 'magnet:?xt=urn:btih:9228628504cc40efa57bf38e85c9e3bd2c572b5b&dn=archlinux-2017.10.01-x86_64.iso&tr=udp://tracker.archlinux.org:6969&tr=https://pirateflix.app      cli._getTorrent(link, type).then(res => {
  ...
  function testMoviePrompt(isAnime: boolean): void {
    ...
    it('should run the movie content prompt', done => {
      ...
      stub.resolves({
        imdb: 'tt1234567',
        torrent: 'magnet:?xt=urn:btih:9228628504cc40efa57bf38e85c9e3bd2c572b5b&dn=archlinux-2017.10.01-x86_64.iso&tr=udp://tracker.archlinux.org:6969&tr=https://pirateflix.app        quality: '720p',
        language: 'en'
      })
  ...
  function testContent(t: string): void {
    ...
    it(`should run the --content option with the '${t}'`, done => {
      const stub = sinon.stub(inquirer, 'prompt')
      stub.resolves({
        torrent: 'magnet:?xt=urn:btih:9228628504cc40efa57bf38e85c9e3bd2c572b5b&dn=archlinux-2017.10.01-x86_64.iso&tr=udp://tracker.archlinux.org:6969&tr=https://pirateflix.app      })
